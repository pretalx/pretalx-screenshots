...
def screenshot(client, name):
    ...
    required_width = client.execute_script('return document.body.parentNode.scrollWidth')
    required_height = client.execute_script('return document.body.parentNode.scrollHeight')
